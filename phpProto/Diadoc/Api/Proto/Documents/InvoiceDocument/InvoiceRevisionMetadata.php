...
/**
 * Generated from protobuf message <code>Diadoc.Api.Proto.Documents.InvoiceDocument.InvoiceRevisionMetadata</code>
 */
class InvoiceRevisionMetadata extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>optional .Diadoc.Api.Proto.Documents.InvoiceDocument.InvoiceStatus InvoiceRevisionStatus = 1;</code>
     */
    ...
    {
        return isset($this->InvoiceRevisionStatus) ? $this->InvoiceRevisionStatus : 0;
    }

    public function hasInvoiceRevisionStatus()
    {
        return isset($this->InvoiceRevisionStatus);
    }

    public function clearInvoiceRevisionStatus()
    {
        unset($this->InvoiceRevisionStatus);
    }
